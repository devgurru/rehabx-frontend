...
/*
 * Shared with the caregiver app (mobile/src/exercise3d/ChildAvatar.tsx) — keep in sync.
 * Only the react-three-fiber import differs (the mobile copy uses @react-three/fiber/native).
 */
